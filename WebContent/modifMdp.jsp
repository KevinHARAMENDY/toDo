...
<html>
	...
	<body class="container-fluid" style="background-color:black;color:white;text-align:center">
		...
		<h1>TO DO APP</h1><br/>
		<h3>Modification du mot de passe de <span style="color:#0083FF"><%= session.getAttribute("nom") %></span></h3><br/>
		<form method="post" action="./updateMdp">
			<div>Mot de passe : 
				<input type="text" style="border-color:white;background-color:black;color:#0083FF" name="newMdp" value="<%= session.getAttribute("mdp") %>">
			</div>
			<input type="hidden" name="idMdp" value="<%= session.getAttribute("id") %>">
